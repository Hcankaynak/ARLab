...
public class OrbitOxygen : MonoBehaviour
{
    ...
    private void Start()
    {
        electron = Instantiate(electron, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
        electron1 = Instantiate(electron1, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
        electron2 = Instantiate(electron2, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
        electron3 = Instantiate(electron3, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
        electron4 = Instantiate(electron4, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
        electron5 = Instantiate(electron5, transform.position + new Vector3(0, 0.03f, 0), transform.rotation);
